                    ...
                    do {
                        ...
                        switch (ch2) {
                            ...
                            case 2:
                                System.out.println("\nEnter name of book:");
                                String b1 = sc.next();
                                List<String> list = new ArrayList<String>(Arrays.asList(bookNames));
                                int ind;
                                /*
                                 * for(int j=0;j<bookNames.length;j++)
                                 * {
                                 * if(bookNames[j].equalsIgnoreCase(b1))
                                 * {
                                 * list.remove("b1");
                                 * bookNames=list.toArray(new String[0]);
                                 * break;
                                 * //continue;
                                 * }
                                 * 
                                ...
                                if (index != -1) {
                                    if (array[index].book_no >= 2) {
                                        ...
                                        for (j = 0; j < arr.length; j++) {
                                            ...
                                            if (bookNames[j] != null
                                                    && String.valueOf(bookNames[j]).equalsIgnoreCase(book)) {
                            ...
                            case 2:
                                try {
                                    ...
                                    for (k = 0; k < array.length; k++) {
                                        if (array[k].id_no == s_id && (array[k].book1 != null
                                                && array[k].book1.equalsIgnoreCase(Rbook)
                                    ...
                                    if (ind != -1) {
                                        ...
                                        for (j = 0; j < arr.length; j++) {
                                            if (bookNames[j] != null
                                                    && String.valueOf(bookNames[j]).equalsIgnoreCase(Rbook)) {
                                                n = j;
                                                bookFound = true;
                                ...
                                if (purchaseBookFound) {
                                    ...
                                    if (purchaseQuantity < 0) {
                                        ...
                                        if (memberStatus.equalsIgnoreCase("Yes")) {
                                            ...
                                            if (mpass.equalsIgnoreCase("abc123")) {

                                                double discountedPrice = bookPrice * 0.8;
                                            ...
                                            if (becomeMember.equalsIgnoreCase("Yes")) {
                                                ...
                                                if (payMembershipFee.equalsIgnoreCase("Yes")) {
                                                    ...
                                                    System.out.println("Your total price: "
                                                            + ((bookPrice * purchaseQuantity) + fee) + "Rs");
                                                } else {
                                                ...
                                                System.out.println(
                                                        "Your total price: " + bookPrice * purchaseQuantity + "Rs");
                                            }
